  ...
  return (
    <footer className="relative bg-slate-50 pt-20 pb-12 overflow-hidden border-t border-slate-200/60">
      <div className="max-w-7xl mx-auto px-4 space-y-20 relative z-10">
        {/* Top Newsletter Row */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center pb-12 border-b border-slate-200">
          <div className="lg:col-span-6 space-y-2">
            <h2 className="text-4xl sm:text-5xl font-extrabold text-slate-900 tracking-tight leading-none">
              Your Smile Matters <br />
              <span className="text-slate-900">Connect With Us Today</span>
            </h2>
          </div>
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex items-center gap-2 bg-white p-2 rounded-full border border-slate-200 shadow-sm max-w-md">
                <div className="flex items-center gap-2 px-3 flex-1 text-slate-400">
                  ...
                  <input
                    ...
                    className="bg-transparent border-none text-slate-900 placeholder:text-slate-400 text-xs focus:outline-none w-full py-1.5"
                  />
                </div>
                <button
                  type="submit"
                  className="bg-cyan-500 hover:bg-cyan-600 text-white font-bold px-6 py-2.5 rounded-full transition-all duration-300 shadow-md shadow-cyan-500/25 shrink-0 text-xs"
                >
                  Subscribe
                </button>
              </form>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-6 grid grid-cols-3 gap-6 text-xs">
            <div className="space-y-4">
              <span className="font-extrabold uppercase tracking-wider text-slate-400 block text-[11px]">COMPANY</span>
            ...
            <div className="space-y-4">
              <span className="font-extrabold uppercase tracking-wider text-slate-400 block text-[11px]">RESOURCES</span>
              <ul className="space-y-2.5 font-medium text-slate-600">
            ...
            <div className="space-y-4">
              <span className="font-extrabold uppercase tracking-wider text-slate-400 block text-[11px]">LEGAL</span>
              <ul className="space-y-2.5 font-medium text-slate-600">
          ...
          <div className="lg:col-span-6 space-y-6 lg:pl-10">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <a href="#facebook" aria-label="Facebook" className="w-9 h-9 rounded-full bg-white border border-slate-200 hover:border-cyan-500 hover:text-cyan-600 text-slate-700 flex items-center justify-center transition-all shadow-sm">
                  <Globe className="w-4 h-4" />
                </a>
                <a href="#instagram" aria-label="Instagram" className="w-9 h-9 rounded-full bg-white border border-slate-200 hover:border-cyan-500 hover:text-cyan-600 text-slate-700 flex items-center justify-center transition-all shadow-sm">
                  <MessageCircle className="w-4 h-4" />
                </a>
                <a href="#twitter" aria-label="Twitter" className="w-9 h-9 rounded-full bg-white border border-slate-200 hover:border-cyan-500 hover:text-cyan-600 text-slate-700 flex items-center justify-center transition-all shadow-sm">
                  <Share2 className="w-4 h-4" />
                </a>
                <a href="#youtube" aria-label="YouTube" className="w-9 h-9 rounded-full bg-white border border-slate-200 hover:border-cyan-500 hover:text-cyan-600 text-slate-700 flex items-center justify-center transition-all shadow-sm">
      ...
      {/* Giant Typography Watermark Background (Right Aligned matching Orbix Screenshot 5) */}
      <div className="absolute right-0 bottom-0 text-watermark translate-x-12 translate-y-12 select-none pointer-events-none opacity-[0.04]">
        Dentora
      </div>
    </footer>
  );
