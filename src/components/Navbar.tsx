    ...
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 py-4 transition-all duration-300">
      ...
      >
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          <div className="w-8 h-8 rounded-full bg-cyan-400 flex items-center justify-center text-slate-950 font-bold shadow-md shadow-cyan-400/30 group-hover:scale-105 transition-transform">
            <svg
        ...
        <div className="hidden sm:flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-cyan-400 hover:bg-cyan-300 text-slate-950 font-bold px-5 py-2 rounded-full transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg shadow-cyan-400/25 group text-xs"
          >
            <span>Book a Call</span>
            <div className="w-5 h-5 rounded-full bg-slate-950/20 flex items-center justify-center group-hover:translate-x-0.5 transition-transform">
